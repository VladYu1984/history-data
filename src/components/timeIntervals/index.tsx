...
import { ArrowControlsStatus } from '@/components/ArrowControls';
import getActualPointToIndex from '@/utils/timeIntervals/getActualPointsToIndex';
import getNearestPointToIndex from '@/utils/timeIntervals/getNearestPointToIndex';
import changePointToZPosition from '@/utils/timeIntervals/gsap/changePointToZPosition';
...
import showPointLabel from '@/utils/timeIntervals/gsap/hidePointLabel';
...
function TimeIntervals({
  ...
  useEffect(() => {
    ...
    function handleMouseMove(e: MouseEvent) {
      ...
      const nearestPointIndex = getNearestPointToIndex({
        ax: circleX,
        ay: circleY,
        bx: e.pageX,
        by: e.pageY,
      ...
      const actualNearestPointIndex = getActualPointToIndex({
      ...
      changePointToZPosition({ point: actualPoint, direction: 'up' });
